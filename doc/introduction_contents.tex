...
\begin{frame}[fragile]
  ...
  Typical structure:
  \begin{itemize}
    \item Program code in \texttt{/src} of the repository.
    \item Report and presentation in \texttt{/doc} of the repository.
    \item Figures shared between report an presentation in \texttt{/doc/figs} of the repository.
  \end{itemize}
\end{frame}
