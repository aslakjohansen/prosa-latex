...
\begin{frame}[fragile]
  ...
  \begin{center}
    \begin{tikzpicture}
      \newcommand{\height}[0]{34mm}
      
      \tikzstyle{dedge} = [thick,->,>=stealth,draw=black]
      
      \node[rectangle,thick,draw,minimum height=\height] (code) at (0,0) {
        \begin{minipage}{5cm}
          \begin{minted}{latex}
...
\end{itemize}
      ...
      \node[rectangle,thick,anchor=west,draw,minimum height=\height] (output) at ([xshift=1cm]code.east) {
        \begin{minipage}{5cm}
          Programming languages:
          \begin{itemize}
            \item Rust
