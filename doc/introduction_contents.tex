...
\begin{frame}[fragile]
  ...
  \begin{itemize}
    ...
    \descitem{lualatex} The most modern engine is scriptable through Lua. It also fixes the issues with \textdesc{pdflatex} and is under active development. It is even slower though. This is the way to go for new projects.
      \begin{itemize}
