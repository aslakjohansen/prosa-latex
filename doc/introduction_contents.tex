...
\begin{frame}[fragile]
  ...
  \vspace{5mm}
  The \packagename{dirtytalk} package gives access to the \commandname{say} command. This command takes one parameter and wraps it in the proper quotation marks.
  
  \vspace{5mm}
  It can be included by putting the following in the \textsl{preample}:
...
\begin{frame}[fragile]
  ...
  \vspace{3mm}
  As programmers, we usually have a good understanding of the problems of having all of our code in a single file.
...
\begin{frame}[fragile]
  \frametitle{Overall Structure \subpart{Structure of Contentss}}
  \vspace{3mm}
