...
\begin{frame}[fragile]
  ...
  \vspace{5mm}
  The \packagename{dirtytalk} package gives access to the \commandname{say} command. This command takes one parameter and wraps it in the proper quotation marks, like \say{so}.
