...
\begin{frame}[fragile]
  ...
  \begin{tikzpicture}[remember picture,overlay]
    ...
    \node[rectangle,anchor=north west,fill=purple,minimum height=\height,minimum width=\width] (pa) at (docclass.south west) {};
    \node[anchor=west] () at (pa.east) {Preample};
    
    \node[anchor=north west] (begin) at (pa.south west) {\mintinline{latex}{\begin{document}}};
    
    \node[rectangle,anchor=north west,fill=purple,minimum height=\height,minimum width=\width] (fm) at (begin.south west) {};
    \node[anchor=west] () at (fm.east) {Front Matter};
    
    \node[rectangle,anchor=north west,fill=purple,minimum height=\height,minimum width=\width] (main) at (fm.south west) {};
    \node[anchor=west] () at (main.east) {Main Matter};
    
    \node[rectangle,anchor=north west,fill=purple,minimum height=\height,minimum width=\width] (bm) at (main.south west) {};
