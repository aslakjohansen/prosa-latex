...
\subsubsection{File Format: Nodes}
\begin{frame}[fragile]
  \frametitle{Graph Layout \subpart{File Format: Nodes}}
  \vspace{-2mm}
...
\subsubsection{File Format: Edges}
\begin{frame}[fragile]
  \frametitle{Graph Layout \subpart{File Format: Edges}}
  \vspace{12mm}
