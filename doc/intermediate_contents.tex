...
\begin{frame}[fragile]
  ...
  \begin{tikzpicture}[remember picture, overlay]
    ...
    \coordinate (squarecoord) at ([xshift=-4cm] current page.center);
    \coordinate (circlecoord) at ([xshift=4cm] current page.center);
    
    \node[rectangle,draw,minimum height=3cm,minimum width=3cm] (square) at (squarecoord) {};
    \node[circle,draw,minimum height=3cm,minimum width=3cm] (circle) at (circlecoord) {};
