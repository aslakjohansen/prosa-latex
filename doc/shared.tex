...
\usepackage{xcolor} % for colored cells in tables and color names
...
\usepackage{relsize} % for resizing minted environments
\usepackage{changepage} % for temporary margin adjustments
\usepackage{ifthen} % for booleans and branching without relying on command arguments
\usepackage{fontspec} % for \setmonofont
...
\newcommand{\mathvarname}[1]{\mathtt{\textcolor{teal}{#1}}}
\newcommand{\typename}[1]{\texttt{\textcolor{purple}{#1}}}
\newcommand{\mathtypename}[1]{\mathtt{\textcolor{purple}{#1}}}
\newcommand{\classname}[1]{\typename{#1}}
\newcommand{\mathclassname}[1]{\mathtypename{#1}}
...
\newcommand{\propertyname}[1]{\texttt{#1}}
\newcommand{\keywordname}[1]{\texttt{#1}}
\newcommand{\subpart}[1]{\textcolor{teal}{$\vartriangleright$} #1}
\newcommand{\termname}[1]{\textcolor{purple}{\textsl{#1}}}
\newcommand{\commandname}[1]{\texttt{\textcolor{teal}{#1}}}
\newcommand{\envname}[1]{\texttt{\textcolor{teal}{#1}}}
...
\author{\presentationauthor \hspace{1mm} \presentationauthoremail}
\date{\presentationdate}
\logo{\vspace{-0.5mm}\includegraphics[width=15mm]{figs/SVG_Prosa_Black_Orange_RGB.pdf}\hspace{0.5mm}}
